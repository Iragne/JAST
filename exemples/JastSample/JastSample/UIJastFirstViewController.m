...
- (void) socketIODidConnect:(SocketIO *)socket{
    NSLog(@"Connected");
    NSDictionary *dict = @{@"client":@"1", @"key": @"7c7b2bfaa4ee4094b390e94c2212aed04326871c", @"app":@"2",@"channel":@"adelskott",@"url":@"http://search.twitter.com/search.json?q=sexy&rpp=30&include_entities=true&result_type=recent",@"ttl":@"3"};
