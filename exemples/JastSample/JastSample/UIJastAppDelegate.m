...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    viewController1 = [[UIJastFirstViewController alloc] initWithNibName:@"UIJastFirstViewController_iPhone" bundle:nil];
    viewController2 = [[UIJastSecondViewController alloc] initWithNibName:@"UIJastSecondViewController_iPhone" bundle:nil];
